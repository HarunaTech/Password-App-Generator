...
function getPasswordOptions() {
  ...
  var lowerCaseConfirmation = confirm(
    "Do you want to have lower case characters in your Password?"
  );
  var upperCaseConfirmation = confirm(
    "Do you want to have UPPERCASE characters in your Password?"
  );
  var numericConfirmation = confirm(
    "Do you want to have Numeric characters in your Password?"
  );
  ...
  if (
    lowerCaseConfirmation === false &&
    upperCaseConfirmation === false &&
    numericConfirmation === false &&
    specialCharactersConfirmation === false
  ) {
    alert(
      "At least one charater must be selected in order to generate password. Please choose one charater type from the previous option!"
    );
    return null;
  }
...
function generatePassword() {
  ...
  for (let i = 0; i < passwordOptions.passwordlength; i++) {
    ...
    newPasswordArray.push(possibleCharacter);
  }
